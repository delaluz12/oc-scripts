...
export async function PatchHeadstartProducts<InputType = any, ReturnType = any>(
  ...
  //   }
  //   const adminSdk = await ocClient(
  //     creds.clientID,
  //     creds.clientSecret,
  //     'Staging'
  //   );
  //   const supplierSdk = await ocClient(
  //     creds.clientID,
  //     creds.clientSecret,
  //     'Staging'
  //   );
  ...
  async function CleanUpSupplierUsers(): Promise<void> {
    ...
    //   suppliers.Items,
    //   async function singleOperation(supplier: Supplier): Promise<void> {
    //     try {
    //       await adminSdk.SupplierUsers.Delete(
    //         supplier.ID!,
    //         `scriptuser-${supplier.ID}`
    //       );
    //     } catch {}
    //   }
    // );
  ...
  //       const patchBody = partialProducts.find(
  ...
  //             await supplierSdk.Products.Patch(product.ID!, patchBody, {
